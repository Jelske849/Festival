...
<body>
  ...
  <section class="page-section clearfix">
    <div class="container">
      <div class="intro">
        <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="img/ingang.jpg" alt="">
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">Het festival</span>
            <span class="section-heading-lower">Speakers</span>
          </h2>
          <p class="mb-3">Het festival van het jaar! <br> Begin deze zomer van 20 juni tot en met 23 juni 2020
          </p>
          <div class="intro-button mx-auto">
          <?php if(isset( $_SESSION['login'])) {?>
            <a class="btn btn-primary btn-xl" href="tickets.php">Koop nu je tickets!</a>
            <?php } else { ?>
              <a class="btn btn-primary btn-xl" href="inloggen.php">Koop nu je tickets!</a>
            <?php } ?>
          </div>
        </div>
      </div>
